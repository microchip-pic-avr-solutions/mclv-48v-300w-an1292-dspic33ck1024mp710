...
## Sensorless FOC using PLL Estimator for PMSM : MCLV-48V-300W and dsPIC33CK1024MP710 Motor Control DIM


## 1. INTRODUCTION
This document describes the setup requirements for driving a Permanent Magnet Synchronous Motor (PMSM) using Sensorless Field Oriented Control (FOC) and PLL Estimator Algorithms on the hardware platform MCLV-48V-300W Inverter Board and dsPIC33CK1024MP710 Motor Control Dual In-line Module (DIM).
...
- Navigate to the [main page of this repository](https://github.com/microchip-pic-avr-solutions/mclv-48v-300w-an1292-dsPIC33CK1024MP710) and 
...
- dsPIC33CK1024MP710 Motor Control Dual In-line Module (EV04L63A)
...
1. Motor currents are amplified on the MCLV-48V-300W Inverter Board. Motor Currents can also be amplified by the amplifiers internal to the dsPIC33CK1024MP710 on the DIM. The firmware and DIM are configured to sample and convert internal amplifier outputs (**'internal op-amp configuration'**) by default to measure the motor currents needed to implement FOC. 

2. Insert the **dsPIC33CK1024MP710 Motor Control DIM** into the DIM Interface **connector J8** on the MCLV-48V-300W Inverter Board. Make sure the DIM is placed correctly and oriented before going ahead.
...
1. Start **MPLAB X IDE** and open the project **pmsm.X (File > Open Project)** with device selection **dsPIC33CK1024MP710.**  
    <p align="left">
...
4. Right-click on the project **pmsm.X** and select **Properties** to open its **Project Properties** Dialog. Click the **Conf:[default]** category to reveal the general project configuration information. The development tools used for testing the firmware are listed in section [2.2 Software Tools Used for Testing the firmware.](#22-software-tools-used-for-testing-the-firmware).
     ...
     - Ensure the selected **Device** is **dsPIC33CK1024MP710.**
...
6. To build the project (in this case, **pmsm.X**) and program the device dsPIC33CK1024MP710, click **Make and Program Device Main project** on the toolbar
    <p align="left">
...
5. dsPIC33CK1024MP710 Family datasheet [(DS70005496)](https://ww1.microchip.com/downloads/aemDocuments/documents/MCU16/ProductDocuments/DataSheets/dsPIC33CK1024MP710-Family-Data-Sheet-DS70005496.pdf)
